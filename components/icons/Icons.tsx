...
export const UploadIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 16.5V9.75m0 0l-3.75 3.75M12 9.75l3.75 3.75M3.75 18A5.25 5.25 0 009 20.25h6A5.25 5.25 0 0020.25 15a5.25 5.25 0 00-1.01-3.07A6.75 6.75 0 0012 4.5a6.75 6.75 0 00-6.23 4.43A5.25 5.25 0 003.75 15.75" />
  </svg>
);
...
export const RocketIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.82m5.84-2.56a6 6 0 01-7.38 5.84m2.56-5.84a6 6 0 01-5.84-7.38v4.82m5.84 2.56a6 6 0 017.38-5.84m-2.56 5.84a6 6 0 015.84 7.38v-4.82m-5.84-2.56a6 6 0 01-7.38 5.84m2.56-5.84a6 6 0 01-5.84-7.38v4.82m5.84 2.56a6 6 0 017.38-5.84" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 2.25c.394 0 .783.023 1.168.066 3.149.336 5.56 2.759 5.896 5.906.043.385.066.774.066 1.168 0 .394-.023.783-.066 1.168-.336 3.149-2.759 5.56-5.906 5.896-.385.043-.774.066-1.168.066-.394 0-.783-.023-1.168-.066-3.149-.336-5.56-2.759-5.896-5.906-.043-.385-.066-.774-.066-1.168 0-.394.023-.783.066 1.168.336-3.149 2.759-5.56 5.906-5.896.385-.043.774-.066 1.168-.066z" />
  </svg>
);
...
export const WrenchIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.83-5.83M11.42 15.17l-4.24-4.24a5.25 5.25 0 017.42 0L21 17.25M3 11.25l4.24-4.24a5.25 5.25 0 017.42 0L17.25 10.5" />
    </svg>
);
